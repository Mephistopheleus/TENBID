...
class EventTypes:
    ...
    ANALYSIS_PASS_STARTED = "ANALYSIS_PASS_STARTED"
    ANALYSIS_PASS_COMPLETED = "ANALYSIS_PASS_COMPLETED"
    ANALYSIS_PASS_FAILED = "ANALYSIS_PASS_FAILED"
    FORECAST_MATRIX_BUILT = "FORECAST_MATRIX_BUILT"
    STATE_MATRIX_BUILT = "STATE_MATRIX_BUILT"
    SCENARIO_BUILT = "SCENARIO_BUILT"
    TRADE_PLAN_CREATED = "TRADE_PLAN_CREATED"
    RISK_DECISION_CREATED = "RISK_DECISION_CREATED"
    EXECUTOR_REQUEST_CREATED = "EXECUTOR_REQUEST_CREATED"
    EXECUTOR_RESULT_RECORDED = "EXECUTOR_RESULT_RECORDED"
    ORDER_STATUS_RECONCILED = "ORDER_STATUS_RECONCILED"
    ORDER_STATUS_RECONCILIATION_FAILED = "ORDER_STATUS_RECONCILIATION_FAILED"
    POSITION_MANAGER_RECORDED = "POSITION_MANAGER_RECORDED"
    SHADOW_SCENARIO_CREATED = "SHADOW_SCENARIO_CREATED"
    LAB_EXPERIMENT_CREATED = "LAB_EXPERIMENT_CREATED"
    AUTOTUNE_EVIDENCE_RECORDED = "AUTOTUNE_EVIDENCE_RECORDED"
    TRADE_EXECUTION_REPORT_CREATED = "TRADE_EXECUTION_REPORT_CREATED"
