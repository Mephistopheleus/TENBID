...
class ShadowLab:
    def __init__(self, system=None, db_path: str = "trade_history.db", low_weight_threshold: float = 0.25):
        self.system = system
        self.db_path = db_path
        self.low_weight_threshold = low_weight_threshold
        self.is_running = False
        self.results_buffer = []
        self.weak_factors_from_calculator = []
        self.logger = logging.getLogger(__name__)
        
        # Динамические гипотезы
        self.hypotheses = [
            LabHypothesis(
